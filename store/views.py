...
def search(request):
    if 'keyword' in request.GET:
        ...
        if keyword:
            product = Product.objects.order_by('-created_date').filter(Q(product_name__icontains=keyword) | Q(other_name__icontains=keyword) |  Q(description__icontains=keyword))
